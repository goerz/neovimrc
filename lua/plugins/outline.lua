return {
  {
    ...
    opts = {
      ...
      outline_window = {
        ...
        -- Percentage or number of columns
        width = 40,
        relative_width = false,  -- if true, `width` is percent
      ...
      symbols = {
        ...
        icons = {
          ...
          Module = { icon = 'ℳ', hl = 'Include' },
          Namespace = { icon = '🌐', hl = 'Include' },
          Package = { icon = '📦', hl = 'Include' },
          Class = { icon = '𝒞', hl = 'Type' },
          Method = { icon = '𝓂', hl = 'Function' },
          Property = { icon = '𝓅', hl = 'Identifier' },
          Field = { icon = '𝓅', hl = 'Identifier' },
          Constructor = { icon = '𝒞', hl = 'Special' },
          Enum = { icon = 'ℰ', hl = 'Type' },
          Interface = { icon = 'ℐ', hl = 'Type' },
          Function = { icon = '𝒻', hl = 'Function' },
          Variable = { icon = '𝓋', hl = 'Constant' },
          Constant = { icon = '𝒸', hl = 'Constant' },
          String = { icon = '𝓈', hl = 'String' },
          Number = { icon = '𝓃', hl = 'Number' },
          Boolean = { icon = '𝒷', hl = 'Boolean' },
          Array = { icon = '𝒶', hl = 'Constant' },
          Object = { icon = 'ℴ', hl = 'Type' },
          Key = { icon = '𝓀', hl = 'Type' },
          Null = { icon = '∅', hl = 'Type' },
          EnumMember = { icon = '', hl = 'Identifier' },
          Struct = { icon = '𝒮', hl = 'Structure' },
          Event = { icon = 'ℯ', hl = 'Type' },
          ...
          StaticMethod = { icon = '𝒻', hl = 'Function' },
          Macro = { icon = '𝓂', hl = 'Function' },
        },
      },
    },
